...
const NavBar : React.FC<NavBarProps> = ({visible}) => {
  return  (
    <nav className={`absolute top-16 w-full bg-[#FFF] px-[10%] flex ${!visible && 'hidden'} flex-col items-stretch space-y-2 py-4 text-center lg:static lg:flex lg:flex-row lg:items-center lg:w-auto lg:space-x-4 lg:space-y-0`} >
